(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define('promiseMiddleware', ['../', 'sinon'], factory);
  } else if (typeof exports !== "undefined") {
    factory(require('../'), require('sinon'));
  } else {
    var mod = {
      exports: {}
    };
    factory(global._, global.sinon);
    global.promiseMiddleware = mod.exports;
  }
})(this, function (_, _sinon) {
  'use strict';
